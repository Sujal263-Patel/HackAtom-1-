    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl p-8 shadow-sm">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          {Object.keys(isotopes).map((isotope) => (
            <button
              key={isotope}
            ...
            >
              ...
              <div className="text-sm text-gray-600">${isotopes[isotope].currentPrice}/Ci</div>
            </button>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {currentIsotope.regions.map((region, index) => (
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm">
            ...
            <div className="space-y-4">
              {currentIsotope.applications.map((app, index) => (
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm">
            ...
            <div className="h-80 bg-gray-50 rounded-lg p-6 mb-6">
              <div className="flex justify-between items-end h-full">
                {currentIsotope.futurePrice.map((price, index) => (
      ...
      {analysisType === 'applications' && (
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {currentIsotope.opportunities.map((opportunity, index) => (
